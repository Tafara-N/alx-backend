...
- A documentation is not a simple word, itΓÇÖs a real sentence explaining whatΓÇÖs the purpose of the module, class or method (the length of it will be verified)
